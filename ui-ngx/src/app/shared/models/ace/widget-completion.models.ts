  ...
  ctx: {
    ...
    children: {
      ...{
        ...
        settings: {
          description: 'Widget settings containing widget specific properties according to the defined <a href="https://linkstuffs.com/docs/user-guide/contribution/widgets-development/#settings-schema-section">settings json schema</a>',
          meta: 'property',
          type: 'object'
        },
        datasources: {
