# Docker configuration for Linkstuffs Microservices

This folder containing scripts and Docker Compose configurations to run Linkstuffs in Microservices mode.

## Prerequisites

Linkstuffs Microservices are running in dockerized environment.
Before starting please make sure [Docker CE](https://docs.docker.com/install/) and [Docker Compose](https://docs.docker.com/compose/install/) are installed in your system.

## Installation

Before performing initial installation you can configure the type of database to be used with Linkstuffs.
...
You should see Linkstuffs login page.
...
For example to see Linkstuffs node logs execute the following command:
...
- `FROM_VERSION` - from which version upgrade should be started. See [Upgrade Instructions](https://linkstuffs.com/docs/user-guide/install/upgrade-instructions) for valid `fromVersion` values.
