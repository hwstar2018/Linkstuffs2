...
public class DefaultSystemDataLoaderService implements SystemDataLoaderService {
    ...
    public void createSysAdmin() {
        createUser(Authority.SYS_ADMIN, null, null, "sysadmin@linkstuffs.com", "sysadmin");
    }
    ...
    public void createAdminSettings() throws Exception {
        ...
        node.put("mailFrom", "Linkstuffs <sysadmin@localhost.localdomain>");
    ...
    public void loadDemoData() throws Exception {
        ...
        createUser(Authority.TENANT_ADMIN, demoTenant.getId(), null, "tenant@linkstuffs.com", "tenant");
        ...
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerA.getId(), "customer@linkstuffs.com", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerA.getId(), "customerA@linkstuffs.com", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerB.getId(), "customerB@linkstuffs.com", CUSTOMER_CRED);
        createUser(Authority.CUSTOMER_USER, demoTenant.getId(), customerC.getId(), "customerC@linkstuffs.com", CUSTOMER_CRED);
