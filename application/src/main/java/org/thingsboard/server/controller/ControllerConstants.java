...
public class ControllerConstants {
    ...
    protected static final String TRANSPORT_CONFIGURATION = "# Transport Configuration" + NEW_LINE +
            ...
            "Please refer to the [docs](https://linkstuffs.com/docs/user-guide/device-profiles/#transport-configuration) for more details about other types.\n" +
    ...
    protected static final String PROVISION_CONFIGURATION = "# Provision Configuration" + NEW_LINE +
            ...
            "Please refer to the [docs](https://linkstuffs.com/docs/user-guide/device-provisioning/) for more details." + NEW_LINE;
