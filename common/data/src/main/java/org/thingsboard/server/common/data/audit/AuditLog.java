...
public class AuditLog extends BaseData<AuditLogId> {
    ...
    @ApiModelProperty(position = 8, value = "Unique user name(email) of the user that performed some action on logged entity", example = "tenant@linkstuffs.com", accessMode = ApiModelProperty.AccessMode.READ_ONLY)
